        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text='➕ HTTP',
                    callback_data='PROXY|ADD|HTTP|M'
                ),
                InlineKeyboardButton(
                    text='➕ SOCKS5',
                    callback_data='PROXY|ADD|SOCKS5|M'
                )
            ],
            [
                InlineKeyboardButton(
                    text='📁 HTTP',
                    callback_data='PROXY|TXT|HTTP|M'
                ),
                InlineKeyboardButton(
                    text='📁 SOCKS5',
                    callback_data='PROXY|TXT|SOCKS5|M'
                )
            ],
            [
                InlineKeyboardButton(
                    text=f'🚫 [{len(await select_proxy_socks_5s())}] Удаление',
                    callback_data='PROXY|DELETE|M|1'
                ),
            ],
            [
                InlineKeyboardButton(
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    ...
                    callback_data=f'PROXY|ADD|{scheme}|T|0'
                )
            ],
            [
                InlineKeyboardButton(
                    text='2️⃣ username:password:hostname:port',
                    callback_data=f'PROXY|ADD|{scheme}|T|1'
                )
            ],
            [
                InlineKeyboardButton(
                    text='3️⃣ hostname:port@username:password',
                    callback_data=f'PROXY|ADD|{scheme}|T|2'
                )
            ],
            [
                InlineKeyboardButton(
                    text='4️⃣ hostname:port:username:password',
                    callback_data=f'PROXY|ADD|{scheme}|T|3'
                )
            ],
            [
                InlineKeyboardButton(
    ...
    markup = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text='1️⃣ username:password@hostname:port',
                    callback_data=f'PROXY|TXT|{scheme}|T|0'
                )
            ],
            [
                InlineKeyboardButton(
                    text='2️⃣ username:password:hostname:port',
                    callback_data=f'PROXY|TXT|{scheme}|T|1'
                )
            ],
            [
                InlineKeyboardButton(
                    text='3️⃣ hostname:port@username:password',
                    callback_data=f'PROXY|TXT|{scheme}|T|2'
                )
            ],
            [
                InlineKeyboardButton(
                    text='4️⃣ hostname:port:username:password',
                    callback_data=f'PROXY|TXT|{scheme}|T|3'
                )
            ],
            [
                InlineKeyboardButton(
...
async def delete_proxy_kb(page):
    ...
    for write in current_writes:
        buttons.append([
            InlineKeyboardButton(
                ...
                callback_data=f'PROXY|DELETE|D|{page}'
            ),]
        )
    manage_buttons = []
    if page > 2:
    ...
    buttons.append([InlineKeyboardButton(text='📛 Удалить все', callback_data=f'PROXY|DELETE|ALL|{page}')])
    buttons.append([InlineKeyboardButton(text='‹ Назад', callback_data='PROXY|M')])
