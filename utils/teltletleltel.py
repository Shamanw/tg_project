...
logging.basicConfig(level=logging.INFO, format=u'%(filename)s:%(lineno)d #%(levelname)-8s [%(asctime)s] - %(name)s - %(message)s')
            ...
            # device_model='Samsung SM-S931B',
            # system_version='15 (35)',
            # app_version='11.7.0 (56631)',
            # #lang_pack='android',
            # lang_code='jabka',

api_id = 27011010
api_hash = '7bf4228fbc11a8b88c91556dffb5186e'
__version__ = "7.1.25"
...
API_IDS = ["27011010", api_id,]
API_HASHS = ["7bf4228fbc11a8b88c91556dffb5186e", api_hash,]
...
# ]
# API_HASHS = [
#     '7bf4228fbc11a8b88c91556dffb5186e',
# ]
